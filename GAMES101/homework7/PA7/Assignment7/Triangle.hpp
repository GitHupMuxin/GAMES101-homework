...
{
public:
    MeshTriangle(const std::string& filename, Material *mt = new Material(), Vector3f Trans = Vector3f(0.0), Vector3f Scale = Vector3f(1.0), Vector3f xr = Vector3f(1.f, 0, 0), Vector3f yr = Vector3f(0, 1, 0), Vector3f zr = Vector3f(0, 0, 1))
    {
        objl::Loader loader;
